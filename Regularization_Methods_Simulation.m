...
PCA_deriv_matrix = deriv_matrix_2;
%PCA_deriv_matrix = deriv_matrix;
A_PCA            = Conv_Matrix*B_PCA*inv(PCA_deriv_matrix);
...
[ knots_coeff_PCA ] = Regularized_Sol( A_PCA    , Sim_Ct_T_noise, knots0, lambda_vec(4), normalize, 0 );
...
inv_matrix_3 = B_PCA * inv(PCA_deriv_matrix);

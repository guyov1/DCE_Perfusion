...
if (plot_error_results_flag)
    ...
    if iterate_uniformly
        ...
        annotation('textbox',...
            ...
            '',...
            ['F                   - Err. %         = ' num2str(mean(error_percent_F               ),'%5.2f') ' +- ' num2str(std(error_percent_F                )) '        [mL/100g/min]'],...
            ['E                   - Err. %         = ' num2str(mean(error_percent_E               ),'%5.2f') ' +- ' num2str(std(error_percent_E                )) '        []'],...
            ['Vp                 - Err. %         = ' num2str(mean(error_percent_Vb_2CXM         ),'%5.2f') ' +- ' num2str(std(error_percent_Vb_2CXM          )) '        [mL/100g]'],...
            ['Ve                 - Err. %         = ' num2str(mean(error_percent_Ve_2CXM         ),'%5.2f') ' +- ' num2str(std(error_percent_Ve_2CXM          )) '        [mL/100g]'],...
            ['F Sourbron   - Err. %         = ' num2str(mean(error_percent_Sourbron_F      ),'%5.2f') ' +- ' num2str(std(error_percent_Sourbron_F       )) '        [mL/100g/min]'],...
            ['Vp Sourbron - Err. %         = ' num2str(mean(error_percent_Vb_Sourbron_2CXM),'%5.2f') ' +- ' num2str(std(error_percent_Vb_Sourbron_2CXM )) '        [mL/100g]'],...
            ['Ve Sourbron - Err. %         = ' num2str(mean(error_percent_Ve_Sourbron_2CXM),'%5.2f') ' +- ' num2str(std(error_percent_Ve_Sourbron_2CXM )) '        [mL/100g]']},...
            'FontSize',8,...
            'FontName','Arial',...
            'LineStyle','-',...
            'EdgeColor',[0 0 0],...

...
if (num_total_voxels > 1000)
    ...
    F_Model_Selected_3D (ChosenByAIC_3D==7) = Inf_map                      (ChosenByAIC_3D==7);
    F_Model_Selected_3D (ChosenByAIC_3D==6) = Inf_map                      (ChosenByAIC_3D==6);
    ...
    F_Model_Selected_3D (ChosenByAIC_3D==2) = Inf_map                      (ChosenByAIC_3D==2);
    ...
    E_Model_Selected_3D (ChosenByAIC_3D==7) = Ktrans_with_Delay_High_F_3D  (ChosenByAIC_3D==7);
    E_Model_Selected_3D (ChosenByAIC_3D==6) = Ktrans_no_Delay_High_F_3D    (ChosenByAIC_3D==6);
